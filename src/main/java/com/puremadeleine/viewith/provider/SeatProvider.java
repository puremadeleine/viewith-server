...
public class SeatProvider {
    ...
    public SeatEntity getSeat(Long venueId, String section, String seatRow, String seatColumn) {
        return seatCustomRepository.findSeat(venueId, section, seatRow, seatColumn)
                .orElseThrow(() ->
